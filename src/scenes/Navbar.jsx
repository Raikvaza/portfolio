...
const Link = ({page, selectedPage, setSelectedPage, isTopOfPage}) => {
    ...
    return (
        <AnchorLink
            className={`${selectedPage === lowerCasePage ? "text-yellow border-b-2 border-yellow" : ""}
...
const Navbar = ({ isTopOfPage,selectedPage, setSelectedPage}) => {
    ...
    const logoBackground = isTopOfPage ? "../assets/logo.png" : "../assets/logo-white.png";
    return (
        // CONTAINER
        <div className={`${navbarBackground} z-40 w-full fixed top-0 py-3 backdrop-blur-lg`}>
            <div 
                className="
                    flex 
                    items-center 
